...
define( 'FS_METHOD', 'direct' ); //Pour forcer les mises a jours,plugins et thèmes sans passer par FTP
define( 'WP_DEBUG_LOG', true );
define( 'DISALLOW_FILE_MODS', false ); //Pour empêcher de mettre de nouveaux plugin et thème pour tout casser
define( 'AUTOMATIC_UPDATER_DISABLED', false ); //Pour empêcher les mises a jour automatiques
